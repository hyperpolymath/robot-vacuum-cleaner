...
=== link:#section-1[1.0.0] - 2024-11-22
...
** Advanced path planning algorithms (A*, spiral, zigzag, wall-follow,
random)
...
. *Documentation*: Update README, CHANGELOG, API docs
. *Version Bump*: Update version in all files
. *Tag*: Create git tag `+vX.Y.Z+`
. *Build*: Create release artifacts
. *Sign*: GPG sign release artifacts
. *Publish*: Push to registries (PyPI, crates.io, container registry)
. *Announce*: Release notes, social media, mailing list
...
SECURITY.md file - This CHANGELOG under relevant version
...
* https://github.com/Hyperpolymath/robot-vacuum-cleaner/compare/v1.0.0...HEAD[Unreleased
Changes]
* https://github.com/Hyperpolymath/robot-vacuum-cleaner/releases/tag/v1.0.0[1.0.0
Release]
...
https://semver.org/[Semantic Versioning] *Last Updated*: 2024-11-22
