...
Robot Vacuum Cleaner — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./robot-vacuum-cleaner-portable
----
...
[source]
----
Robot Vacuum Cleaner started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/robot-vacuum-cleaner/wiki
