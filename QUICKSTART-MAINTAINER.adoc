...
// Replace robot-vacuum-cleaner, robot-vacuum-cleaner, {{DEPS}} with actuals
...
This guide covers packaging, deploying, and maintaining robot-vacuum-cleaner for
...
podman build -t robot-vacuum-cleaner .
----
...
| `$PREFIX/share/robot-vacuum-cleaner/`
| Data files, assets

| `$PREFIX/share/doc/robot-vacuum-cleaner/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/robot-vacuum-cleaner/config.toml`

Fallback: `$HOME/.config/robot-vacuum-cleaner/config.toml`
...
Or via OPSM: `opsm update robot-vacuum-cleaner`
...
[source,bash]
----
just install --prefix=/opt/robot-vacuum-cleaner-instance1 --config=/etc/robot-vacuum-cleaner/instance1.toml
just install --prefix=/opt/robot-vacuum-cleaner-instance2 --config=/etc/robot-vacuum-cleaner/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/robot-vacuum-cleaner/issues
