...
doctor:
    @echo "Running diagnostics for robot-vacuum-cleaner..."
...
heal:
    @echo "Attempting auto-repair for robot-vacuum-cleaner..."
...
tour:
    @echo "=== robot-vacuum-cleaner Tour ==="
    @echo ""
...
help-me:
    @echo "=== robot-vacuum-cleaner Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/robot-vacuum-cleaner/issues/new"
    @echo ""
